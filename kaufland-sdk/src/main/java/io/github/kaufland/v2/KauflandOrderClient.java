package io.github.kaufland.v2;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.github.kaufland.KauflandClient;
import io.github.kaufland.v2.dto.OrdersDTO;
import io.github.kaufland.v2.dto.UploadInvoiceDTO;
...
public class KauflandOrderClient extends KauflandClient {
    ...
    /**
     * https://sellerapi.kaufland.com/?page=orders
     */
    ...
    /**
     * 更新发票
     * https://sellerapi.kaufland.com/?page=order-invoices#upload-order-invoice
     */
    ...
    /**
     * 获取订单
     * https://sellerapi.kaufland.com/?page=orders#retrieving-order-units
     *
     * @param appKey    appKey
     * @param secretKey 密钥
     */
