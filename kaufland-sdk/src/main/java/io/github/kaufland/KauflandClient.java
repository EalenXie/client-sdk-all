...
public abstract class KauflandClient {
    ...
    public HttpHeaders getHttpHeadersWithSign(String appKey, String secretKey, HttpMethod method, String body, URI uri) {
        ...
        String signatureString = getSignatureString(method.name(), uri.toString(), body == null ? "" : body, timestamp);
    ...
    /**
     * 获取签名字符串
     * 签名字符串算法: https://sellerapi.kaufland.com/?page=rest-api#signrequest-java
     */
