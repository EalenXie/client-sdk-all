...
import io.github.walmart.marketplace.vo.WalmartToken;
...
public abstract class WalmartClient {
    ...
    protected WalmartClient() {
        this(new RestTemplate());
    }

    protected WalmartClient(RestOperations restOperations) {
     ...
     * @return 访问令牌
     */
    public WalmartToken clientCredentialsAccessToken(String clientId, String clientSecret) {
