package io.github.ebay;

import io.github.ebay.dto.EbayFilterDTO;
import io.github.ebay.vo.EbayAccessToken;
...
public abstract class EbayClient {
    ...
    protected EbayClient(RestOperations restOperations) {
     ...
     */
    public EbayAccessToken clientCredentialsAccessToken(String clientId, String clientSecret) {
